    ...
    public static void main(String args[]) throws IOException {
        ...
        for (int i = 1; i < 4;) {
            ...
            if (user.equals("1") && password.equals("1")) {
                ...
                for (int x = 1; x == 1;) {
                    //the main menue to show the details
                    System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
                    ...
                    for (x = 1; x == 1;) {
                        ...
                        if (choice.equals("1")) {
                            ...
                            System.out.println("=> 2.)KARUR        | 170 |   " + available[2] + "   **");
                            System.out.println("=> 3.)PALAKAD      | 150 |   " + available[3] + "   **");
                            System.out.println("=> 4.)RAMESHWARAM  | 200 |   " + available[4] + "   **");
                            System.out.println("=> 5.)TIRUPATHI    | 250 |   " + available[5] + "   **");
                            System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
                            System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
                            ...
                            if ((available[1] == 0) && (available[2] == 0) && (available[3] == 0) && (available[4] == 0) && (available[5] == 0)) {
                                ...
                                String dest[] = {" ", "CHENNAI", "KARUR", "PALAKAD", "RAMESHWARAM", "TIRUPATHI"};
                            ...
                            for (x = 1; x == 1;) {
                                ...
                                for (int b = 0; b < z; b++) {
                                    if (search.equalsIgnoreCase(ticketS[b][0])) {
                                        ...
                                        s = 0;
                                        x = 0;
                                        //it shows the payment details of the passenger
                            ...
                            for (int sx = 1; sx <= 3;) {
                                ...
                                int s = 1;
                                for (x = 0; x <= z; x++) {
                                    //it showa the details for the ticket booked for the pasanger and details
                                    if (search.equalsIgnoreCase(ticketS[x][0])) {
                                        ...
                                        // it shows the payment and resipt
